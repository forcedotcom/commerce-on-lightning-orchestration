...
export const BASE_DIR = homedir + '/.b2c'; // ; `${__dirname}/../../../..` // use commented if you just want to do local
...
export const STORE_DIR = (dir = BASE_DIR, hubOrgAdminUsername, scratchOrgAdminUsername, storeName) =>
  `${SCRATCH_ORG_DIR(dir, hubOrgAdminUsername, scratchOrgAdminUsername)}${storeName ? '/' + cleanName(storeName) : ''}`;
...
export const PACKAGE_RETRIEVE_TEMPLATE = (dir = BASE_DIR) =>
